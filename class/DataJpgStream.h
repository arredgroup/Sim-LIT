...
**/
#ifndef CLASS_DATAJPGSTREAM
#define CLASS_DATAJPGSTREAM
...
class DataJpgStream: public DataType{
...
public:
	...
	DataJpgStream(vector<unsigned char*> nElement, vector<int> oBytes, vector<int> nBytes){
	/**
