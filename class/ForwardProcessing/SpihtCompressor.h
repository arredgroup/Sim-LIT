/**
  @file SpihtCompressor.h
  @class SpihtCompressor
  @brief Clase que implementa un tipo de compresión de SPIHT 
  @author Christopher Arredondo Flores
  @date 01/01/2016

**/

#ifndef CLASS_SPIHTCOMPRESSOR
#define CLASS_SPHITCOMPRESSOR
...
class SpihtCompressor: public ForwardProcessing{
